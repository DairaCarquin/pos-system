    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeHttpRequests(
                ...
                .requestMatchers("/", "/css/**", "/js/**", "/img/**", "/images/**", "/webjars/**", "/home-ventas/img/**","/home-ventas/css/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST,"/ventas-online/guardar").permitAll()
                        .requestMatchers(HttpMethod.POST,"/ventas-online/eliminar/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST,"/ventas-online/editar/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET,"/ventas-online/nuevo").permitAll()
